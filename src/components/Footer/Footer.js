        ...
        <div className="grid grid-cols-6 gap-x-7 gap-y-14 pt-24 pb-12 md:grid-cols-12">
          ...
          {/* Logo */}
            <a href="index.html" className="mb-6 inline-block">
              <img src="assets/img/logo_dev.png" className="max-h-7 dark:hidden" alt="Xhibiter | NFT Marketplace"></img>
              <img src="assets/img/logo_white.png" className="hidden max-h-7 dark:block" alt="Xhibiter | NFT Marketplace"></img>
            </a>
            <p className="mb-12 dark:text-jacarta-300">
              Connect, explore  and  Learn from Creative devs . Powered by DevbyDevs.co.
            </p>
            {/* Socials */}
