...
//     return (
//         <>
//         <body className="overflow-x-hidden font-body text-jacarta-500 dark:bg-jacarta-900" itemscope="" itemtype="http://schema.org/WebPage">
// =
//     {/* Header */}
...
//           <img src="img/logo.png" className="max-h-7 dark:hidden" alt="Xhibiter | NFT Marketplace"></img>
//           <img src="img/logo_white.png" className="hidden max-h-7 dark:block" alt="Xhibiter | NFT Marketplace"></img>
//         </a>
...
//             <input type="search" className="w-full rounded-2xl border border-jacarta-100 py-3 px-4 pl-10 text-jacarta-700 placeholder-jacarta-500 focus:ring-accent dark:border-transparent dark:bg-white/[.15] dark:text-white dark:placeholder-white" placeholder="Search"></input>
...
//                       <span className="font-display text-sm text-accent">Home 4</span>
//                     </a>
//                   </li>
//                   <li>
...
//                       <span className="mr-4 font-display text-sm text-jacarta-700 dark:text-white">Home 7</span>
...
//                       <span className="mr-4 font-display text-sm text-jacarta-700 dark:text-white">Home 8</span>
//                       <span className="rounded bg-green py-1 px-2 text-xxs font-bold uppercase leading-none text-white">new</span>
//                     </a>
//                   </li>
//                   <li>
...
//                       <span className="mr-4 font-display text-sm text-jacarta-700 dark:text-white">Home 9</span>
//                       <span className="rounded bg-green py-1 px-2 text-xxs font-bold uppercase leading-none text-white">new</span>
//                     </a>
//                   </li>
//                   <li>
...
//                       <span className="mr-4 font-display text-sm text-jacarta-700 dark:text-white">Home 10</span>
//                       <span className="rounded bg-green py-1 px-2 text-xxs font-bold uppercase leading-none text-white">new</span>
//                     </a>
//                   </li>
//                   <li>
...
//                       <span className="mr-4 font-display text-sm text-jacarta-700 dark:text-white">Home 11</span>
//                       <span className="rounded bg-green py-1 px-2 text-xxs font-bold uppercase leading-none text-white">new</span>
//                     </a>
//                   </li>
//                 </ul>
...
//                     <svg version="1.1" xmlns="http://www.w3.org/2000/svg" x="0" y="0" viewBox="0 0 1920 1920" xml:space="preserve" className="-ml-1 mr-1 h-[1.125rem] w-[1.125rem]">
...
//           <img src="img/gradient.jpg" alt="gradient"></img>
//         </picture>
//         <picture className="pointer-events-none absolute inset-x-0 top-0 -z-10 hidden dark:block">
//           <img src="img/gradient_dark.jpg" alt="gradient dark"></img>
//         </picture>
...
//               <input type="search" className="w-full rounded-2xl border border-jacarta-100 py-4 px-4 pl-10 text-md text-jacarta-700 placeholder-jacarta-300 focus:ring-accent dark:border-transparent dark:bg-white/[.15] dark:text-white dark:placeholder-white" placeholder="Search by Collection, NFT or user"></input>
//               <span className="absolute left-0 top-0 flex h-full w-12 items-center justify-center rounded-2xl">
//                 <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" className="h-4 w-4 fill-jacarta-500 dark:fill-white">
//                   <path fill="none" d="M0 0h24v24H0z"></path>
//                   <path d="M18.031 16.617l4.283 4.282-1.415 1.415-4.282-4.283A8.96 8.96 0 0 1 11 20c-4.968 0-9-4.032-9-9s4.032-9 9-9 9 4.032 9 9a8.96 8.96 0 0 1-1.969 5.617zm-2.006-.742A6.977 6.977 0 0 0 18 11c0-3.868-3.133-7-7-7-3.868 0-7 3.132-7 7 0 3.867 3.132 7 7 7a6.977 6.977 0 0 0 4.875-1.975l.15-.15z"></path>
...
//             <a href="#" className="text-accent hover:text-jacarta-700 dark:hover:text-white">cryptopunks</a><span>,</span>
//             <a href="#" className="text-accent hover:text-jacarta-700 dark:hover:text-white">bored ape yacht club</a><span>,</span>
//             <a href="#" className="text-accent hover:text-jacarta-700 dark:hover:text-white">moonbirds</a>
//           </div>
//         </div>
//       </section>
//       {/* end hero */}
...
//                     <a href="item.html">
//                       <img src="img/products/item_13_lg.gif" alt="item 1" className="swiper-lazy h-[430px] w-full object-cover" height="430" width="379"></img>
...
//                         <img src="img/avatars/avatar_18_rounded.gif" alt="avatar" className="mr-4 h-10 w-10 rounded-full"></img>
//                       </a>
//                       <div>
//                         <a href="item.html" className="block">
//                           <span className="font-display text-lg leading-none text-jacarta-700 hover:text-accent dark:text-white">Etherium NFT Launching Lab</span>
//                         </a>
//                         <a href="#" className="text-2xs text-accent">051_Hart</a>
//                       </div>
//                     </div>
//                   </div>
//                 </div>
...
//                   <figure className="relative">
//                     <a href="item.html">
//                       <img src="img/products/item_16_lg.jpg" alt="item 1" className="swiper-lazy h-[430px] w-full object-cover" height="430" width="379"></img>
//                       <div className="swiper-lazy-preloader"></div>
//                     </a>
//                   </figure>
//                   <div className="p-6">
//                     <div className="flex">
//                       <a href="user.html" className="shrink-0">
//                         <img src="img/avatars/avatar_22_rounded.jpg" alt="avatar" className="mr-4 h-10 w-10 rounded-full"></img>
//                       </a>
//                       <div>
//                         <a href="item.html" className="block">
...
//                   <figure className="relative">
//                     <a href="item.html">
//                       <img src="img/products/item_12_lg.jpg" alt="item 1" height="430" width="379" className="swiper-lazy h-[430px] w-full object-cover"></img>
//                       <div className="swiper-lazy-preloader"></div>
//                     </a>
//                   </figure>
//                   <div className="p-6">
//                     <div className="flex">
//                       <a href="user.html" className="shrink-0">
//                         <img src="img/avatars/avatar_17_rounded.jpg" alt="avatar" className="mr-4 h-10 w-10 rounded-full"></img>
//                       </a>
//                       <div>
//                         <a href="item.html" className="block">
//                           <span className="font-display text-lg leading-none text-jacarta-700 hover:text-accent dark:text-white">Light Bars</span>
//                         </a>
//                         <a href="#" className="text-2xs text-accent">Wow Frens</a>
//                       </div>
//                     </div>
//                   </div>
//                 </div>
...
//                   <figure className="relative">
//                     <a href="item.html">
//                       <img src="img/pixel.jpg" data-src="./img/products/item_14_lg.jpg" alt="item 1" className="swiper-lazy h-[430px] w-full object-cover" height="430" width="379"></img>
//                       <div className="swiper-lazy-preloader"></div>
//                     </a>
//                   </figure>
//                   <div className="p-6">
//                     <div className="flex">
//                       <a href="user.html" className="shrink-0">
//                         <img src="img/avatars/avatar_19_rounded.jpg" alt="avatar" className="mr-4 h-10 w-10 rounded-full"></img>
//                       </a>
//                       <div>
//                         <a href="item.html" className="block">
//                           <span className="font-display text-lg leading-none text-jacarta-700 hover:text-accent dark:text-white">Amazing NFT art</span>
//                         </a>
//                         <a href="#" className="text-2xs text-accent">Lila Spacex</a>
//                       </div>
//                     </div>
//                   </div>
//                 </div>
...
//                   <figure className="relative">
//                     <a href="item.html">
//                       <img src="img/pixel.jpg" data-src="./img/products/item_15_lg.jpg" alt="item 1" className="swiper-lazy h-[430px] w-full object-cover" height="430" width="379"></img>
//                       <div className="swiper-lazy-preloader"></div>
//                     </a>
//                   </figure>
//                   <div className="p-6">
//                     <div className="flex">
//                       <a href="user.html" className="shrink-0">
//                         <img src="img/avatars/avatar_20_rounded.jpg" alt="avatar" className="mr-4 h-10 w-10 rounded-full"></img>
//                       </a>
//                       <div>
//                         <a href="item.html" className="block">
//                           <span className="font-display text-lg leading-none text-jacarta-700 hover:text-accent dark:text-white">SwagFox#133</span>
//                         </a>
//                         <a href="#" className="text-2xs text-accent">Bored Bunny</a>
//                       </div>
//                     </div>
//                   </div>
//                 </div>
...
//           <img src="img/gradient_light.jpg" alt="gradient" className="h-full w-full"></img>
//         </picture>
//         <div className="container">
...
//                   <img src="img/avatars/avatar_1.jpg" alt="avatar 1" className="rounded-2lg" loading="lazy"></img>
...
//               <figure className="mr-4 shrink-0">
//                 <a href="collection.html" className="relative block">
//                   <img src="img/avatars/avatar_2.jpg" alt="avatar 2" className="rounded-2lg" loading="lazy"></img>
...
//               <figure className="mr-4 shrink-0">
//                 <a href="collection.html" className="relative block">
//                   <img src="img/avatars/avatar_3.jpg" alt="avatar 3" className="rounded-2lg" loading="lazy"></img>
//                   <div className="absolute -left-3 top-1/2 flex h-6 w-6 -translate-y-2/4 items-center justify-center rounded-full border-2 border-white bg-jacarta-700 text-xs text-white dark:border-jacarta-600">
//                     3
//                   </div>
//                 </a>
...
//               <figure className="mr-4 shrink-0">
//                 <a href="collection.html" className="relative block">
//                   <img src="img/avatars/avatar_4.jpg" alt="avatar 4" className="rounded-2lg" loading="lazy"></img>
//                   <div className="absolute -left-3 top-1/2 flex h-6 w-6 -translate-y-2/4 items-center justify-center rounded-full border-2 border-white bg-jacarta-700 text-xs text-white dark:border-jacarta-600">
//                     4
//                   </div>
//                 </a>
...
//               <figure className="mr-4 shrink-0">
//                 <a href="collection.html" className="relative block">
//                   <img src="img/avatars/avatar_5.jpg" alt="avatar 5" className="rounded-2lg" loading="lazy"></img>
//                   <div className="absolute -left-3 top-1/2 flex h-6 w-6 -translate-y-2/4 items-center justify-center rounded-full border-2 border-white bg-jacarta-700 text-xs text-white dark:border-jacarta-600">
//                     5
//                   </div>
//                 </a>
...
//               <figure className="mr-4 shrink-0">
//                 <a href="collection.html" className="relative block">
//                   <img src="img/avatars/avatar_6.gif" alt="avatar 6" className="rounded-2lg" loading="lazy"></img>
//                   <div className="absolute -left-3 top-1/2 flex h-6 w-6 -translate-y-2/4 items-center justify-center rounded-full border-2 border-white bg-jacarta-700 text-xs text-white dark:border-jacarta-600">
//                     6
//                   </div>
//                 </a>
...
//               <figure className="mr-4 shrink-0">
//                 <a href="collection.html" className="relative block">
//                   <img src="img/avatars/avatar_7.jpg" alt="avatar 7" className="rounded-2lg" loading="lazy"></img>
//                   <div className="absolute -left-3 top-1/2 flex h-6 w-6 -translate-y-2/4 items-center justify-center rounded-full border-2 border-white bg-jacarta-700 text-xs text-white dark:border-jacarta-600">
//                     7
//                   </div>
//                   <div className="absolute -left-3 top-[60%] flex h-6 w-6 items-center justify-center rounded-full border-2 border-white bg-green dark:border-jacarta-600" data-tippy-content="Verified Collection">
...
//               <figure className="mr-4 shrink-0">
//                 <a href="collection.html" className="relative block">
//                   <img src="img/avatars/avatar_8.jpg" alt="avatar 8" className="rounded-2lg" loading="lazy"></img>
//                   <div className="absolute -left-3 top-1/2 flex h-6 w-6 -translate-y-2/4 items-center justify-center rounded-full border-2 border-white bg-jacarta-700 text-xs text-white dark:border-jacarta-600">
//                     8
//                   </div>
//                   <div className="absolute -left-3 top-[60%] flex h-6 w-6 items-center justify-center rounded-full border-2 border-white bg-green dark:border-jacarta-600" data-tippy-content="Verified Collection">
...
//               <figure className="mr-4 shrink-0">
//                 <a href="collection.html" className="relative block">
//                   <img src="img/avatars/avatar_9.jpg" alt="avatar 9" className="rounded-2lg" loading="lazy"></img>
//                   <div className="absolute -left-3 top-1/2 flex h-6 w-6 -translate-y-2/4 items-center justify-center rounded-full border-2 border-white bg-jacarta-700 text-xs text-white dark:border-jacarta-600">
//                     9
//                   </div>
//                 </a>
...
//               <figure className="mr-4 shrink-0">
//                 <a href="collection.html" className="relative block">
//                   <img src="img/avatars/avatar_11.jpg" alt="avatar 11" className="rounded-2lg" loading="lazy"></img>
//                   <div className="absolute -left-3 top-1/2 flex h-6 w-6 -translate-y-2/4 items-center justify-center rounded-full border-2 border-white bg-jacarta-700 text-xs text-white dark:border-jacarta-600">
//                     11
//                   </div>
//                 </a>
...
//               <figure className="mr-4 shrink-0">
//                 <a href="collection.html" className="relative block">
//                   <img src="img/avatars/avatar_12.jpg" alt="avatar 12" className="rounded-2lg" loading="lazy"></img>
//                   <div className="absolute -left-3 top-1/2 flex h-6 w-6 -translate-y-2/4 items-center justify-center rounded-full border-2 border-white bg-jacarta-700 text-xs text-white dark:border-jacarta-600">
//                     12
//                   </div>
//                 </a>
...
//               <figure className="mr-4 shrink-0">
//                 <a href="collection.html" className="relative block">
//                   <img src="img/avatars/avatar_13.jpg" alt="avatar 13" className="rounded-2lg" loading="lazy"></img>
//                   <div className="absolute -left-3 top-1/2 flex h-6 w-6 -translate-y-2/4 items-center justify-center rounded-full border-2 border-white bg-jacarta-700 text-xs text-white dark:border-jacarta-600">
//                     13
//                   </div>
//                   <div className="absolute -left-3 top-[60%] flex h-6 w-6 items-center justify-center rounded-full border-2 border-white bg-green dark:border-jacarta-600" data-tippy-content="Verified Collection">
...
//               <figure className="mr-4 shrink-0">
//                 <a href="collection.html" className="relative block">
//                   <img src="img/avatars/avatar_14.jpg" alt="avatar 14" className="rounded-2lg" loading="lazy"></img>
//                   <div className="absolute -left-3 top-1/2 flex h-6 w-6 -translate-y-2/4 items-center justify-center rounded-full border-2 border-white bg-jacarta-700 text-xs text-white dark:border-jacarta-600">
//                     14
//                   </div>
//                 </a>
...
//               <figure className="mr-4 shrink-0">
//                 <a href="collection.html" className="relative block">
//                   <img src="img/avatars/avatar_15.jpg" alt="avatar 15" className="rounded-2lg" loading="lazy"></img>
//                   <div className="absolute -left-3 top-1/2 flex h-6 w-6 -translate-y-2/4 items-center justify-center rounded-full border-2 border-white bg-jacarta-700 text-xs text-white dark:border-jacarta-600">
//                     15
//                   </div>
//                   <div className="absolute -left-3 top-[60%] flex h-6 w-6 items-center justify-center rounded-full border-2 border-white bg-green dark:border-jacarta-600" data-tippy-content="Verified Collection">
...
//               <figure className="mr-4 shrink-0">
//                 <a href="collection.html" className="relative block">
//                   <img src="img/avatars/avatar_16.jpg" alt="avatar 16" className="rounded-2lg" loading="lazy"></img>
//                   <div className="absolute -left-3 top-1/2 flex h-6 w-6 -translate-y-2/4 items-center justify-center rounded-full border-2 border-white bg-jacarta-700 text-xs text-white dark:border-jacarta-600">
//                     16
//                   </div>
//                 </a>
...
//             <a href="rankings.html" className="inline-block rounded-full bg-accent py-3 px-8 text-center font-semibold text-white shadow-accent-volume transition-all hover:bg-accent-dark">Go to Rankings</a>
//           </div>
//         </div>
//       </section>
//       {/* end top collections */}
...
//             <span className="mr-1 inline-block h-6 w-6 animate-heartBeat bg-contain bg-center text-xl" style="
//                 background-image: url(../../../npm/emoji-datasource-apple@7.0.2/img/apple/64/2764-fe0f.png);
//               "></span>
//             Live Auctions
//           </h2>
...
//                     <a href="#">
//                       <img src="img/avatars/creator_1.png" alt="creator" className="h-6 w-6 rounded-full" data-tippy-content="Creator: Sussygirl"></img>
//                     </a>
//                     <a href="#">
//                       <img src="img/avatars/owner_1.png" alt="owner" className="h-6 w-6 rounded-full" data-tippy-content="Owner: Sussygirl"></img>
//                     </a>
//                   </div>

//                   <div className="dropdown rounded-full hover:bg-jacarta-100 dark:hover:bg-jacarta-600">
//                     <a href="#" className="dropdown-toggle inline-flex h-8 w-8 items-center justify-center text-sm" role="button" id="itemActions1" data-bs-toggle="dropdown" aria-expanded="false">
...
//                       </svg>
//                     </a>
//                     <div className="dropdown-menu dropdown-menu-end z-10 hidden min-w-[200px] whitespace-nowrap rounded-xl bg-white py-4 px-2 text-left shadow-xl dark:bg-jacarta-800" aria-labelledby="itemActions1">
...
//                         New bid
//                       </button>
//                       <hr className="my-2 mx-4 h-px border-0 bg-jacarta-100 dark:bg-jacarta-600"></hr>
//                       <button className="block w-full rounded-xl px-5 py-2 text-left font-display text-sm transition-colors hover:bg-jacarta-50 dark:text-white dark:hover:bg-jacarta-600">
//                         Refresh Metadata
//                       </button>
//                       <button className="block w-full rounded-xl px-5 py-2 text-left font-display text-sm transition-colors hover:bg-jacarta-50 dark:text-white dark:hover:bg-jacarta-600">
...
//                 <figure className="relative">
//                   <a href="item.html">
//                     <img src="img/products/item_8.jpg" alt="item 8" className="w-full rounded-[0.625rem]" loading="lazy"></img>
//                   </a>
...
//                     <span className="h-3.5 w-3.5 shrink-0 bg-contain bg-center" style="
//                         background-image: url(../../../npm/emoji-datasource-apple@7.0.2/img/apple/64/23f3.png);
//                       "></span>
//                     <span className="js-countdown-timer shrink-0 whitespace-nowrap text-jacarta-700" data-countdown="2023-04-07T11:32:30" data-expired="This auction has ended"></span>
...
//                       <svg version="1.1" xmlns="http://www.w3.org/2000/svg" x="0" y="0" viewBox="0 0 1920 1920" xml:space="preserve" className="h-4 w-4">
//                         <path fill="#8A92B2" d="M959.8 80.7L420.1 976.3 959.8 731z"></path>
//                         <path fill="#62688F" d="M959.8 731L420.1 976.3l539.7 319.1zm539.8 245.3L959.8 80.7V731z"></path>
//                         <path fill="#454A75" d="M959.8 1295.4l539.8-319.1L959.8 731z"></path>
//                         <path fill="#8A92B2" d="M420.1 1078.7l539.7 760.6v-441.7z"></path>
...
//                   <button className="font-display text-sm font-semibold text-accent" data-bs-toggle="modal" data-bs-target="#placeBidModal">
//                     Place bid
//                   </button>
...
//                   <div className="flex -space-x-2">
//                     <a href="#">
//                       <img src="img/avatars/creator_4.png" alt="creator" className="h-6 w-6 rounded-full" data-tippy-content="Creator: Sussygirl"></img>
//                     </a>
//                     <a href="#">
//                       <img src="img/avatars/owner_4.png" alt="owner" className="h-6 w-6 rounded-full" data-tippy-content="Owner: Sussygirl"></img>
//                     </a>
//                   </div>
...
//                         background-image: url(../../../npm/emoji-datasource-apple@7.0.2/img/apple/64/23f3.png);
//                       "></span>
//                     <span className="js-countdown-timer shrink-0 whitespace-nowrap text-jacarta-700" data-countdown="2023-06-01T10:45:30" data-expired="This auction has ended"></span>
//                     <span className="js-countdown-left" data-countdownleft="left"></span>
//                   </div>
//                 </figure>
//                 <div className="mt-7 flex items-center justify-between">
...
//                   <div className="flex -space-x-2">
//                     <a href="#">
//                       <img src="img/avatars/creator_8.png" alt="creator" className="h-6 w-6 rounded-full" data-tippy-content="Creator: Sussygirl"></img>
//                     </a>
//                     <a href="#">
//                       <img src="img/avatars/owner_5.png" alt="owner" className="h-6 w-6 rounded-full" data-tippy-content="Owner: Sussygirl"></img>
//                     </a>
//                   </div>
...
//                 <figure className="relative">
//                   <a href="item.html">
//                     <img src="img/products/item_11.gif" alt="item 6" className="w-full rounded-[0.625rem]" loading="lazy"></img>
//                   </a>
//                   <div className="absolute bottom-4 left-1/2 flex -translate-x-1/2 items-center justify-center space-x-1 rounded-full bg-white py-2.5 px-6 text-2xs font-medium">
//                     <span className="h-3.5 w-3.5 shrink-0 bg-contain bg-center" style="
//                         background-image: url(../../../npm/emoji-datasource-apple@7.0.2/img/apple/64/23f3.png);
//                       "></span>
//                     <span className="js-countdown-timer shrink-0 whitespace-nowrap text-jacarta-700" data-countdown="2023-03-14T10:45:30" data-expired="This auction has ended"></span>
//                     <span className="js-countdown-left" data-countdownleft="left"></span>
//                   </div>
//                 </figure>
//                 <div className="mt-7 flex items-center justify-between">
...
//                   <div className="flex -space-x-2">
//                     <a href="#">
//                       <img src="img/avatars/creator_2.png" alt="creator" className="h-6 w-6 rounded-full" data-tippy-content="Creator: Sussygirl"></img>
//                     </a>
//                     <a href="#">
//                       <img src="img/avatars/owner_7.png" alt="owner" className="h-6 w-6 rounded-full" data-tippy-content="Owner: Sussygirl"></img>
//                     </a>
//                   </div>
...
//                 <figure className="relative">
//                   <a href="item.html">
//                     <img src="img/products/item_10.jpg" alt="item 6" className="w-full rounded-[0.625rem]" loading="lazy"></img>
//                   </a>
//                   <div className="absolute bottom-4 left-1/2 flex -translate-x-1/2 items-center justify-center space-x-1 rounded-full bg-white py-2.5 px-6 text-2xs font-medium">
//                     <span className="h-3.5 w-3.5 shrink-0 bg-contain bg-center" style="
//                         background-image: url(../../../npm/emoji-datasource-apple@7.0.2/img/apple/64/23f3.png);
//                       "></span>
//                     <span className="js-countdown-timer shrink-0 whitespace-nowrap text-jacarta-700" data-countdown="2023-07-14T10:45:30" data-expired="This auction has ended"></span>
//                     <span className="js-countdown-left" data-countdownleft="left"></span>
//                   </div>
//                 </figure>
//                 <div className="mt-7 flex items-center justify-between">
...
//                     </a>
//                     <a href="#">
//                       <img src="img/avatars/owner_2.png" alt="owner" className="h-6 w-6 rounded-full" data-tippy-content="Owner: Sussygirl"></img>
//                     </a>
//                   </div>
...
//                 <figure className="relative">
//                   <a href="item.html">
//                     <img src="img/products/item_17.jpg" alt="item 6" className="w-full rounded-[0.625rem]" loading="lazy"></img>
//                   </a>
//                   <div className="absolute bottom-4 left-1/2 flex -translate-x-1/2 items-center justify-center space-x-1 rounded-full bg-white py-2.5 px-6 text-2xs font-medium">
//                     <span className="h-3.5 w-3.5 shrink-0 bg-contain bg-center" style="
//                         background-image: url(../../../npm/emoji-datasource-apple@7.0.2/img/apple/64/23f3.png);
//                       "></span>
//                     <span className="js-countdown-timer shrink-0 whitespace-nowrap text-jacarta-700" data-countdown="2023-05-14T10:45:30" data-expired="This auction has ended"></span>
//                     <span className="js-countdown-left" data-countdownleft="left"></span>
//                   </div>
//                 </figure>
//                 <div className="mt-7 flex items-center justify-between">
//                   <a href="item.html">
//                     <span className="font-display text-base text-jacarta-700 hover:text-accent dark:text-white">Azuki #4017</span>
//                   </a>
//                   <span className="flex items-center whitespace-nowrap rounded-md border border-jacarta-100 py-1 px-2 dark:border-jacarta-600">
//                     <span data-tippy-content="ETH">
//                       <svg version="1.1" xmlns="http://www.w3.org/2000/svg" x="0" y="0" viewBox="0 0 1920 1920" xml:space="preserve" className="h-4 w-4">
...
//                   <div className="flex -space-x-2">
//                     <a href="#">
//                       <img src="img/avatars/creator_9.png" alt="creator" className="h-6 w-6 rounded-full" data-tippy-content="Creator: Sussygirl"></img>
//                     </a>
//                     <a href="#">
//                       <img src="img/avatars/owner_8.png" alt="owner" className="h-6 w-6 rounded-full" data-tippy-content="Owner: Sussygirl"></img>
//                     </a>
//                   </div>
...
//                 <figure className="relative">
//                   <a href="item.html">
//                     <img src="img/products/item_18.jpg" alt="item 6" className="w-full rounded-[0.625rem]" loading="lazy"></img>
//                   </a>
//                   <div className="absolute bottom-4 left-1/2 flex -translate-x-1/2 items-center justify-center space-x-1 rounded-full bg-white py-2.5 px-6 text-2xs font-medium">
//                     <span className="h-3.5 w-3.5 shrink-0 bg-contain bg-center" style="
//                         background-image: url(../../../npm/emoji-datasource-apple@7.0.2/img/apple/64/23f3.png);
//                       "></span>
//                     <span className="js-countdown-timer shrink-0 whitespace-nowrap text-jacarta-700" data-countdown="2022-09-14T10:45:30" data-expired="This auction has ended"></span>
//                     <span className="js-countdown-left" data-countdownleft="left"></span>
//                   </div>
//                 </figure>
//                 <div className="mt-7 flex items-center justify-between">
//                   <a href="item.html">
//                     <span className="font-display text-base text-jacarta-700 hover:text-accent dark:text-white">Block #2788</span>
//                   </a>
//                   <span className="flex items-center whitespace-nowrap rounded-md border border-jacarta-100 py-1 px-2 dark:border-jacarta-600">
//                     <span data-tippy-content="ETH">
//                       <svg version="1.1" xmlns="http://www.w3.org/2000/svg" x="0" y="0" viewBox="0 0 1920 1920" xml:space="preserve" className="h-4 w-4">
...
//                   <div className="flex -space-x-2">
//                     <a href="#">
//                       <img src="img/avatars/creator_6.png" alt="creator" className="h-6 w-6 rounded-full" data-tippy-content="Creator: Sussygirl"></img>
//                     </a>
//                     <a href="#">
//                       <img src="img/avatars/owner_4.png" alt="owner" className="h-6 w-6 rounded-full" data-tippy-content="Owner: Sussygirl"></img>
//                     </a>
...
//                 <figure className="relative">
//                   <a href="item.html">
//                     <img src="img/products/item_19.jpg" alt="item 6" className="w-full rounded-[0.625rem]" loading="lazy"></img>
//                   </a>
//                   <div className="absolute bottom-4 left-1/2 flex -translate-x-1/2 items-center justify-center space-x-1 rounded-full bg-white py-2.5 px-6 text-2xs font-medium">
//                     <span className="h-3.5 w-3.5 shrink-0 bg-contain bg-center" style="
//                         background-image: url(../../../npm/emoji-datasource-apple@7.0.2/img/apple/64/23f3.png);
//                       "></span>
//                     <span className="js-countdown-timer shrink-0 whitespace-nowrap text-jacarta-700" data-countdown="2022-10-14T10:45:30" data-expired="This auction has ended"></span>
//                     <span className="js-countdown-left" data-countdownleft="left"></span>
//                   </div>
//                 </figure>
//                 <div className="mt-7 flex items-center justify-between">
//                   <a href="item.html">
//                     <span className="font-display text-base text-jacarta-700 hover:text-accent dark:text-white">Crypto bull #6195</span>
//                   </a>
//                   <span className="flex items-center whitespace-nowrap rounded-md border border-jacarta-100 py-1 px-2 dark:border-jacarta-600">
//                     <span data-tippy-content="ETH">
//                       <svg version="1.1" xmlns="http://www.w3.org/2000/svg" x="0" y="0" viewBox="0 0 1920 1920" xml:space="preserve" className="h-4 w-4">
...
//                   <div className="flex -space-x-2">
//                     <a href="#">
//                       <img src="img/avatars/creator_3.png" alt="creator" className="h-6 w-6 rounded-full" data-tippy-content="Creator: Sussygirl"></img>
//                     </a>
//                     <a href="#">
//                       <img src="img/avatars/owner_3.png" alt="owner" className="h-6 w-6 rounded-full" data-tippy-content="Owner: Sussygirl"></img>
//                     </a>
//                   </div>
...
//                 <div className="mt-7 flex items-center justify-between">
//                   <a href="item.html">
//                     <span className="font-display text-base text-jacarta-700 hover:text-accent dark:text-white">TSARÉVNA</span>
//                   </a>
//                   <span className="flex items-center whitespace-nowrap rounded-md border border-jacarta-100 py-1 px-2 dark:border-jacarta-600">
//                     <span data-tippy-content="ETH">
//                       <svg version="1.1" xmlns="http://www.w3.org/2000/svg" x="0" y="0" viewBox="0 0 1920 1920" xml:space="preserve" className="h-4 w-4">
...
//           <div className="mt-10 text-center">
//             <a href="collections.html" className="inline-block rounded-full bg-accent py-3 px-8 text-center font-semibold text-white shadow-accent-volume transition-all hover:bg-accent-dark">Load More</a>
//           </div>
//         </div>
//       </section>
//       {/* end live auctions */}
...
//                 background-image: url(../../../npm/emoji-datasource-apple@7.0.2/img/apple/64/1f4a5.png);
//               "></span>
//             Featured collections
//           </h2>
...
//             <svg xmlns="http://www.w3.org/2000/svg" x="0" y="0" viewBox="0 0 318.6 318.6" xml:space="preserve" className="mb-4 inline-block h-8 w-8">
//               <style>
//                 .st1,
//                 .st6 {
//                   fill: #e4761b;
...
//               <path className="st1" d="M44.4 35.5l98.7 74.6-17.5-44.3zm193.9 171.3l-26.5 40.6 56.7 15.6 16.3-55.3zm-204.4.9L50.1 263l56.7-15.6-26.5-40.6z"></path>
//               <path className="st1" d="M103.6 138.2l-15.8 23.9 56.3 2.5-2-60.5zm111.3 0l-39-34.8-1.3 61.2 56.2-2.5zM106.8 247.4l33.8-16.5-29.2-22.8zm71.1-16.5l33.9 16.5-4.7-39.3z"></path>
//               <path d="M211.8 247.4l-33.9-16.5 2.7 22.1-.3 9.3zm-105 0l31.5 14.9-.2-9.3 2.5-22.1z" fill="#d7c1b3" stroke="#d7c1b3" stroke-linecap="round" stroke-linejoin="round"></path>
//               <path d="M138.8 193.5l-28.2-8.3 19.9-9.1zm40.9 0l8.3-17.4 20 9.1z" fill="#233447" stroke="#233447" stroke-linecap="round" stroke-linejoin="round"></path>
//               <path d="M106.8 247.4l4.8-40.6-31.3.9zM207 206.8l4.8 40.6 26.5-39.7zm23.8-44.7l-56.2 2.5 5.2 28.9 8.3-17.4 20 9.1zm-120.2 23.1l20-9.1 8.2 17.4 5.3-28.9-56.3-2.5z" fill="#cd6116" stroke="#cd6116" stroke-linecap="round" stroke-linejoin="round"></path>
//               <path d="M87.8 162.1l23.6 46-.8-22.9zm120.3 23.1l-1 22.9 23.7-46zm-64-20.6l-5.3 28.9 6.6 34.1 1.5-44.9zm30.5 0l-2.7 18 1.2 45 6.7-34.1z" fill="#e4751f" stroke="#e4751f" stroke-linecap="round" stroke-linejoin="round"></path>
//               <path className="st6" d="M179.8 193.5l-6.7 34.1 4.8 3.3 29.2-22.8 1-22.9zm-69.2-8.3l.8 22.9 29.2 22.8 4.8-3.3-6.6-34.1z"></path>
//               <path fill="#c0ad9e" stroke="#c0ad9e" stroke-linecap="round" stroke-linejoin="round" d="M180.3 262.3l.3-9.3-2.5-2.2h-37.7l-2.3 2.2.2 9.3-31.5-14.9 11 9 22.3 15.5h38.3l22.4-15.5 11-9z"></path>
//               <path fill="#161616" stroke="#161616" stroke-linecap="round" stroke-linejoin="round" d="M177.9 230.9l-4.8-3.3h-27.7l-4.8 3.3-2.5 22.1 2.3-2.2h37.7l2.5 2.2z"></path>
//               <path d="M278.3 114.2l8.5-40.8-12.7-37.9-96.2 71.4 37 31.3 52.3 15.3 11.6-13.5-5-3.6 8-7.3-6.2-4.8 8-6.1zM31.8 73.4l8.5 40.8-5.4 4 8 6.1-6.1 4.8 8 7.3-5 3.6 11.5 13.5 52.3-15.3 37-31.3-96.2-71.4z" fill="#763d16" stroke="#763d16" stroke-linecap="round" stroke-linejoin="round"></path>
//               <path className="st6" d="M267.2 153.5l-52.3-15.3 15.9 23.9-23.7 46 31.2-.4h46.5zm-163.6-15.3l-52.3 15.3-17.4 54.2h46.4l31.1.4-23.6-46zm71 26.4l3.3-57.7 15.2-41.1h-67.5l15 41.1 3.5 57.7 1.2 18.2.1 44.8h27.7l.2-44.8z"></path>
//             </svg>
...
//                 <span>
//                   <svg version="1.1" xmlns="http://www.w3.org/2000/svg" x="0" y="0" viewBox="0 0 1920 1920" xml:space="preserve" className="mr-1 h-5 w-5">
//                     <path fill="#8A92B2" d="M959.8 80.7L420.1 976.3 959.8 731z"></path>
//                     <path fill="#62688F" d="M959.8 731L420.1 976.3l539.7 319.1zm539.8 245.3L959.8 80.7V731z"></path>
//                     <path fill="#454A75" d="M959.8 1295.4l539.8-319.1L959.8 731z"></path>
//                     <path fill="#8A92B2" d="M420.1 1078.7l539.7 760.6v-441.7z"></path>
...
//               <input type="text" className="h-12 w-full flex-[3] border-0 focus:ring-inset focus:ring-accent" placeholder="Amount" value="0.05">
...
//               <label for="terms" className="text-sm dark:text-jacarta-200">By checking this box, I agree to Xhibiter's <a href="#" className="text-accent">Terms of Service</a></label>
//             </div>
//           </div>
//           {/* end body */}
